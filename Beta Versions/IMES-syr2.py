...
from imes_libs import syr2 as syr # module for syringe pump control
...
class App(QMainWindow):  # create the main window
    ...
    ui_layout = 'C:\\Users\\ilia\\IMES\\imes_python\\IMES_layout_syr2.ui'
    #ui_layout = 'C:\\Users\\Marek\\Drive\\Oak Ridge\\Experiment\\Control programs\\IMES-master\\imes_python\\IMES_layout_syr.ui'
    ...
    def __init__(self):  # initialize application
        ...
        self.ui.syr_infuse_B.stateChanged.connect(self.syr_infuse_2)
        ...
        self.ui.syr_on_2.stateChanged.connect(self.syr_2_checked)
        ...
        self.ui.syr_infuse_B.setEnabled(False)
        ...
        self.syr_dict = {
                ...
                'infuse_on_2': self.ui.syr_infuse_B,
                'output_box': self.ui.output_box,
...
# %% ----------- system control functions ------------------------------
    ...
    def quit_app(self):
        ...
        if self.ui.syr_on.isChecked() or self.ui.syr_on_2.isChecked() :
...
# %% ---------- functions for syringe control and sequence ------------------
    ...
    def syr_checked(self):
        ...
        syr.checked(self.syr_dict, 1)
        
    def syr_2_checked(self):
        # Triggers when syringe pump checkbox status changes.
        syr.checked(self.syr_dict, 2)
    ...
    def syr_infuse_2(self):
        if self.syr_dict['infuse_on_2'].isChecked():
            syr.infuse_2(self.syr_dict)
        if not self.syr_dict['infuse_on_2'].isChecked():
            syr.stop_infusing_2(self.syr_dict)
